...
(function() {
  ...
  if(!window.methodDraw) window.methodDraw = function($) {
    ...
    curConfig = {
      ...
      extensions: ['ext-server_opensave.js', 'ext-websocket.js', 'ext-mathsymbols.js'], //**MDP Webocket Added
      initTool: 'select',
      wireframe: false,
      ...
      var setupFlyouts = function(holders) {
        $.each(holders, function(hold_sel, btn_opts) {
          ...
          shower.mousedown(function(evt) {
            ...
            var time = holder.data('shown_popop')?1:0; //**MDP old value 200:1 .. caused problems with both mathlib and shapelib showing
    ...
    var changeCanvasSize = function(ctl){
      ...
      var Actions = function() {
        ...
        var tool_buttons = [
          ...
          {sel:'#tool_text', fn: clickText, evt: 'click', kAy: ['T', true]},
          ...
          {sel:'#tool_move_top', fn: moveToTopSelected, evt: 'click', kAy: modKey + 'shift+up'},
          {sel:'#tool_move_bottom', fn: moveToBottomSelected, evt: 'click', kAy: modKey + 'shift+down'},
          {sel:'#tool_move_up', fn: moveUpSelected, evt:'click', kAy: [modKey+'up', true]},
          {sel:'#tool_move_down', fn: moveDownSelected, evt:'click', kAy: [modKey+'down', true]},
          {sel:'#tool_topath', fn: convertToPath, evt: 'click'},
          {sel:'#tool_make_link,#tool_make_link_multi', fn: makeHyperlink, evt: 'click'},
          {sel:'#tool_clone,#tool_clone_multi', fn: clickClone, evt: 'click', key: [modKey + 'D', true]},
          {sel:'#tool_group', fn: clickGroup, evt: 'click', kAy: [modKey + 'G', true]},
          {sel:'#tool_ungroup', fn: clickGroup, evt: 'click', kAy: modKey + 'shift+G'},
          {sel:'#tool_unlink_use', fn: clickGroup, evt: 'click'},
          {sel:'[id^=tool_align]', fn: clickAlign, evt: 'click'},
          {sel:'#tool_undo', fn: clickUndo, evt: 'click', key: modKey + 'z'},
          {sel:'#tool_redo', fn: clickRedo, evt: 'click', kAy: ['y', true]},
          ...
          {sel:'#tool_switch', fn: clickSwitch, evt: 'click', kAy: ['x', true]},
          {sel:'#tool_bold', fn: clickBold, evt: 'mousedown', kAy: [modKey + 'B', true]},
        //  {sel:'#tool_italic', fn: clickItalic, evt: 'mousedown',  key: [modKey + 'I', true]},
          ...
          {key: 'return', fn: function(){svgCanvas.returnPressed()}},
          ...
          {kAy: modKey + 'A', fn: function(){svgCanvas.selectAllInCurrentLayer();}},
        //  {kAy: 'I', fn: function(){setEyedropperMode()}},
          // {key: ['backspace', true], fn: function(){
          //   if (!multiselected) {
          //     clickUndo();
          //     moveCursor(-2,0);
          //   }
          ...
          //Math Keys
            {key: [String.fromCharCode(97), true], fn: function(){svgCanvas.keyPressed('a');}},
  					{key: ['shift+a', true], fn: function(){svgCanvas.keyPressed('A');}},
  					{key: ['b', true], fn: function(){svgCanvas.keyPressed('b');}},
            {key: ['tab', true], fn: function(){svgCanvas.keyPressed('b');}},
  					{key: ['shift+b', true], fn: function(){svgCanvas.keyPressed('B');}},
  					{key: ['c', true], fn: function(){svgCanvas.keyPressed('c');}},
  					{key: ['shift+c', true], fn: function(){svgCanvas.keyPressed('C');}},
  					{key: ['d', true], fn: function(){svgCanvas.keyPressed('d');}},
  					{key: ['shift+d', true], fn: function(){svgCanvas.keyPressed('D');}},
  					{key: ['e', true], fn: function(){svgCanvas.keyPressed('e');}},
  					{key: ['shift+e', true], fn: function(){svgCanvas.keyPressed('E');}},
  					{key: ['f', true], fn: function(){svgCanvas.keyPressed('f');}},
  					{key: ['shift+f', true], fn: function(){svgCanvas.keyPressed('F');}},
  					{key: ['g', true], fn: function(){svgCanvas.keyPressed('g');}},
  					{key: ['shift+g', true], fn: function(){svgCanvas.keyPressed('G');}},
  					...
  					{key: ['shift+k', true], fn: function(){svgCanvas.keyPressed('K');}},
  					{key: ['l', true], fn: function(){svgCanvas.keyPressed('l');}},
  					{key: ['shift+l', true], fn: function(){svgCanvas.keyPressed('L');}},
  					{key: ['m', true], fn: function(){svgCanvas.keyPressed('m');}},
  					{key: ['shift+m', true], fn: function(){svgCanvas.keyPressed('M');}},
  					{key: ['n', true], fn: function(){svgCanvas.keyPressed('n');}},
  					{key: ['shift+n', true], fn: function(){svgCanvas.keyPressed('N');}},
  					{key: ['o', true], fn: function(){svgCanvas.keyPressed('o');}},
  					{key: ['shift+o', true], fn: function(){svgCanvas.keyPressed('O');}},
  					{key: ['p', true], fn: function(){svgCanvas.keyPressed('p');}},
  					{key: ['shift+p', true], fn: function(){svgCanvas.keyPressed('P');}},
  					{key: ['q', true], fn: function(){svgCanvas.keyPressed('q');}},
  					{key: ['shift+q', true], fn: function(){svgCanvas.keyPressed('Q');}},
  					{key: ['r', true], fn: function(){svgCanvas.keyPressed('r');}},
  					{key: ['shift+r', true], fn: function(){svgCanvas.keyPressed('R');}},
  					{key: ['s', true], fn: function(){svgCanvas.keyPressed('s');}},
  					{key: ['shift+s', true], fn: function(){svgCanvas.keyPressed('S');}},
  					{key: ['t', true], fn: function(){svgCanvas.keyPressed('t');}},
  					{key: ['shift+t', true], fn: function(){svgCanvas.keyPressed('T');}},
  					{key: ['u', true], fn: function(){svgCanvas.keyPressed('u');}},
  					{key: ['shift+u', true], fn: function(){svgCanvas.keyPressed('U');}},
  					{key: ['v', true], fn: function(){svgCanvas.keyPressed('v');}},
  					{key: ['shift+V', true], fn: function(){svgCanvas.keyPressed('V');}},
  					{key: ['w', true], fn: function(){svgCanvas.keyPressed('w');}},
  					{key: ['shift+w', true], fn: function(){svgCanvas.keyPressed('W');}},
  					{key: ['x', true], fn: function(){svgCanvas.keyPressed('x');}},
  					{key: ['shift+x', true], fn: function(){svgCanvas.keyPressed('X');}},
  					{key: ['y', true], fn: function(){svgCanvas.keyPressed('y');}},
  					{key: ['shift+y', true], fn: function(){svgCanvas.keyPressed('Y');}},
  					{key: ['z', true], fn: function(){svgCanvas.keyPressed('z');}},
  					{key: ['shift+Z', true], fn: function(){svgCanvas.keyPressed('Z');}},
  					{key: ['0', true], fn: function(){svgCanvas.keyPressed('0');}},
  					{key: ['1', true], fn: function(){svgCanvas.keyPressed('1');}},
  					{key: ['2', true], fn: function(){svgCanvas.keyPressed('2');}},
  					{key: ['3', true], fn: function(){svgCanvas.keyPressed('3');}},
  					{key: ['4', true], fn: function(){svgCanvas.keyPressed('4');}},
  					{key: ['5', true], fn: function(){svgCanvas.keyPressed('5');}},
